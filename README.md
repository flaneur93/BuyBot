...
### Workflow
1. Open the **Configure** tab, click each ROI selector (Item, Price, **Total Price**, Max, Buy, Close, Balance) and drag the matching on-screen rectangle. Right-click or press `Esc` to cancel.
2. Return to the **Main** tab. Enter `Min Price`, `Max Price`, `Current Balance`, and `Balance Floor`.
